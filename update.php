...
if (isset($_POST['namec'])) {
	...
	mysqli_query($db,"START TRANSACTION");
	$query= "update missing set name='{$_POST['nname']}' where username='{$_SESSION['username']}'";
	if(mysqli_query($db, $query)){
		mysqli_query($db,"COMMIT");
		header('location: index.php');
	}else{
...
if (isset($_POST['agec'])) {
	...
	mysqli_query($db,"START TRANSACTION");
	$query= "update missing set age='{$_POST['nage']}' where username='{$_SESSION['username']}'";
	if(mysqli_query($db, $query)){
		mysqli_query($db,"COMMIT");
		header('location: index.php');
	}else{
...
if (isset($_POST['genderc'])) {
	...
	mysqli_query($db,"START TRANSACTION");
	$query= "update missing set gender='{$_POST['ngender']}' where username='{$_SESSION['username']}'";
	if(mysqli_query($db, $query)){
		mysqli_query($db,"COMMIT");
		header('location: index.php');
	}else{
...
if (isset($_POST['placec'])) {
	...
	mysqli_query($db,"START TRANSACTION");
	$query= "update missing set place='{$_POST['nplace']}' where username='{$_SESSION['username']}'";
	if(mysqli_query($db, $query)){
		mysqli_query($db,"COMMIT");
		header('location: index.php');
	}else{
...
if (isset($_POST['heightc'])) {
	...
	mysqli_query($db,"START TRANSACTION");
	$query= "update missing set height='{$_POST['nheight']}' where username='{$_SESSION['username']}'";
	if(mysqli_query($db, $query)){
		mysqli_query($db,"COMMIT");
		header('location: index.php');
	}else{
...
if (isset($_POST['weightc'])) {
	...
	mysqli_query($db,"START TRANSACTION");
	$query= "update missing set weight='{$_POST['nweight']}' where username='{$_SESSION['username']}'";
	if(mysqli_query($db, $query)){
		mysqli_query($db,"COMMIT");
		header('location: index.php');
	}else{
...
if (isset($_POST['complexionc'])) {
	...
	mysqli_query($db,"START TRANSACTION");
	$query= "update missing set complexion='{$_POST['ncomplexion']}' where username='{$_SESSION['username']}'";
	if(mysqli_query($db, $query)){
		mysqli_query($db,"COMMIT");
		header('location: index.php');
	}else{
